...
(function (global) {
  ...
  var TRACKS = {
    ...
    // とまれ：ドキドキこらえる（スタッカートで弾む）
    tomare: {
      bpm: 126, step: 0.5, type: 'square', leadVol: 0.15,
      lead: ['C5',0,'E5',0,'G5',0,'E5',0,
             'D5',0,'F5',0,'A5',0,0,0,
             'C5',0,'E5',0,'G5','A5','G5','E5',
             'D5','C5','D5',0,'G4',0,0,0],
      bass: ['C3',0,'C3','G2','F2',0,'F2','C3'],
      bassType: 'triangle'
    },
    // どこちがう：きょろきょろ・ふしぎ（ゆれる三連符風）
    chigai: {
      bpm: 96, step: 0.5, type: 'triangle',
      lead: ['E5',0,'C5','D5','E5',0,'G5',0,
             'A5',0,'G5',0,'E5',0,0,0,
             'D5',0,'B4','C5','D5',0,'F5',0,
             'E5',0,'C5',0,'G4',0,0,0],
      bass: ['C3',0,0,0,'A2',0,0,0,'F2',0,0,0,'G2',0,0,0],
      bassType: 'sine'
    },
    // そっくりわけ：ぽいぽい仕分ける（軽快スウィング風）
    sokkuri: {
      bpm: 110, step: 0.5, type: 'triangle',
      lead: ['G4','C5',0,'E5','G5',0,'E5',0,
             'A4','D5',0,'F5','A5',0,'F5',0,
             'G4','C5',0,'E5','G5','A5','G5','E5',
             'D5',0,'C5',0,'C5',0,0,0],
      bass: ['C3','G3','F2','C3','C3','G3','G2','D3'],
      bassType: 'sine'
    },
    // ぺあさがし：そっとめくる（やわらかい・かんがえる）
    pair: {
      bpm: 90, step: 0.5, type: 'sine',
      lead: ['C5',0,'E5',0,'G4',0,'B4',0,
             'C5',0,'A4',0,0,0,0,0,
             'D5',0,'F5',0,'A4',0,'C5',0,
             'B4',0,'G4',0,0,0,0,0],
    ...
    // うたあそび：ドレミのおさんぽ（音階をなぞる）
    uta: {
      bpm: 100, step: 0.5, type: 'sine',
      lead: ['C5','D5','E5',0,'E5','F5','G5',0,
             'G5','A5','G5','E5','C5',0,0,0,
             'A4','B4','C5',0,'D5','E5','D5',0,
             'C5',0,'G4',0,'C5',0,0,0],
      bass: ['C3',0,'G2',0,'F2',0,'G2',0],
      bassType: 'triangle'
    },
    // ぴたごら：コロコロ転がる（はずむ）
    pitagora: {
